      ...
      <section className="container text-gray-100 body-font mt-12 lg:mb-24 lg:mx-auto">
        <div className="lg:mx-auto lg:flex items-center justify-center">
          ...
          {!mailsuccess === true ? (
            ...
            <div
              className="md:w-1/2 rounded-lg py-3 px-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 bg-gray-900 secondary-font"
            >
              <p>Successfully got your <span class="text-2xl text-yellow-400">message</span>, <br/> Thank you !</p>
            </div>
          )}
        </div>
      </section>
